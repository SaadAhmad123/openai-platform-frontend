    ...
    <>
      ...
      {type === 'textarea' ? (
        <textarea
          ...
          value={value || ''}
          onChange={onChange}
          className="block w-full py-2 px-3 border focus:outline-none focus:border-indigo-600 bg-gray-50 dark:bg-[#212526] dark:border-gray-500 focus:dark:border-indigo-400 dark:text-servian-white"
          aria-label={label}
