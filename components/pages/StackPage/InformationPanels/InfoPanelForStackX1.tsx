...
const InfoPanelForStackX1 = ({ stack, IdToken }: InfoPanelForStackV1) => {
    ...
    try {
        ...
        clientWebAppLink = `https://mgpt-client.saad-ahmad.com/?socket=${clientWebSocketUrl}&name=${stack?.name || 'unknown'
            }&prompt_type=default`
    } catch (e) {
        safeConsole()?.error(e)
    }
    ...
    if (stack?.provisioning_stack !== 'stack_x1') return <></>
    return (
...
export default InfoPanelForStackX1
